...
def simulate_strategy(request):
    ...
    adjusted_grid_consumption = grid_consumption * reduction_factor
    ...
    for source in sources:
        additional_consumption = total_consumption * 0.05  # Cada fuente añade un 5% del consumo total
        cost = additional_consumption * source_prices.get(source, 0)
        emissions = additional_consumption * source_emissions.get(source, 0)
    ...
    grid_emissions = adjusted_grid_consumption * 200  # Suponiendo un factor de emisión para la red
